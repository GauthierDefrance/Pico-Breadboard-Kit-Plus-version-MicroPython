...
#----------------------------------------------------------------------
#The code is from Salvator Sanfilippo here is his github : https://github.com/antirez/ST77xx-pure-MP
#Thanks to his works i could make the screen work.
#----------------------------------------------------------------------
...
class ST7789_base:
    ...
    def init(self, landscape=False, mirror_x=False, mirror_y=False, is_bgr=False, xstart = None, ystart = None, inversion = False):
        ...
        if self.cs:
            self.cs.off() # Take this like that forever, much faster than
                          ...
                          # SPI is connected to any other hardware225.
        self.hard_reset()
        self.soft_reset()
    ...
    def _set_mem_access_mode(self, landscape, mirror_x, mirror_y, is_bgr=False):
        value = 0
